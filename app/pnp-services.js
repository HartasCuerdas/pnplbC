 ...
 * @description
 *
 * The `pnpServices` module provides services for interacting with
 * the models exposed by the LoopBack server via the REST API.
 *
 */
var module = angular.module("pnpServices", ['ngResource']);
 ...
 * @description
 *
 * A $resource object for interacting with the `Week` model.
 *
 * ## Example
 *
 * See
